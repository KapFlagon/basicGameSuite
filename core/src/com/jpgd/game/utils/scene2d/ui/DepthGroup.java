package com.jpgd.game.utils.scene2d.ui;
...
/** A group that lays out its children on a Z axis (similar to superclass {@link Group}, with optional wrapping.
 * {@link #getChildren()} can be sorted to change the order of the actors (eg {@link Actor#setZIndex(int)}).
 * This can be easier than using {@link Table} when actors need to be inserted into or removed from the middle of the group.
 * {@link #invalidate()} must be called after changing the children order.
 * <p>
 * The preferred width is the largest preferred width of any child.
 * The preferred height is the sum of the children's preferred heights plus spacing.
 * The preferred size is slightly different when {@link #wrap() wrap} is enabled.
 * The min size is the preferred size and the max size is 0.
 * <p>
 ...
 * Original {@link VerticalGroup} @author Nathan Sweet
 * Edited by Jack Grimes*/

// Copied from VerticalGroup
public class DepthGroup extends WidgetGroup {
    ...
    public DepthGroup reverse () {
        this.reverse = true;
        return this;
    }

    /** If true, the children will be displayed last to first. */
    public DepthGroup reverse (boolean reverse) {
    ...
    public DepthGroup space (float space) {
        this.space = space;
        return this;
    }
    ...
    public DepthGroup wrapSpace (float wrapSpace) {
    ...
    public DepthGroup pad (float pad) {
        padTop = pad;
        padLeft = pad;
        padBottom = pad;
        padRight = pad;
    ...
    public DepthGroup pad (float top, float left, float bottom, float right) {
        padTop = top;
        padLeft = left;
        padBottom = bottom;
        padRight = right;
    ...
    public DepthGroup padTop (float padTop) {
        this.padTop = padTop;
        return this;
    }

    public DepthGroup padLeft (float padLeft) {
        this.padLeft = padLeft;
        return this;
    }

    public DepthGroup padBottom (float padBottom) {
        this.padBottom = padBottom;
        return this;
    }

    public DepthGroup padRight (float padRight) {
    ...
    public DepthGroup fill () {
        fill = 1f;
        return this;
    }

    /** @param fill 0 will use preferred height. */
    public DepthGroup fill (float fill) {
        this.fill = fill;
        return this;
    }
     ...
     * width. */
    public DepthGroup wrap () {
        wrap = true;
        return this;
    }

    public DepthGroup wrap (boolean wrap) {
        this.wrap = wrap;
        return this;
    }
     ...
     * wrapping} is enabled. */
    public DepthGroup columnBottom () {
        columnAlign |= Align.bottom;
        columnAlign &= ~Align.top;
        return this;
    }
